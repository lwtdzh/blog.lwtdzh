this project is deployed to cloudflare pages, with the domain: https://blog-lwtdzh.pages.dev, https://blog.lwtdzh.ip-ddns.com (2 links targets the same source).
